...
-- AddForeignKey
ALTER TABLE "CharacterLocation" ADD CONSTRAINT "CharacterLocation_gameImageId_fkey" FOREIGN KEY ("gameImageId") REFERENCES "GameImage"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "GameCompletion" ADD CONSTRAINT "GameCompletion_gameImageId_fkey" FOREIGN KEY ("gameImageId") REFERENCES "GameImage"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
